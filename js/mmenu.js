...
if(!o.menuspeed) {o.menuspeed=0};
if(!o.menupause) {o.menupause=5};
if(!o.d_colspan) {o.d_colspan=10};
if(!o.allowtransparent) {o.allowtransparent=true};
if(!o.barwidth) {o.barwidth=25};
if(!o.hdingwidth) {o.hdingwidth=111};
if(!o.hdingheight) {o.hdingheight=22};
if(!o.hdingindent) {o.hdingindent=15};
...
if(!o.bartext) {o.bartext="Link Directory"};
